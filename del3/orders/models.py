...
class Content(models.Model):
	order_id = models.ForeignKey(OrderInfo, db_column='order_id', blank=True, null=True, default=1)
	product_id = models.ForeignKey(Product, db_column='product_id', blank=True, null=True, default=1)
